# "What's New" flyer — open queue

Running list of user-facing changes to announce on the **next** "What's New" flyer to the group.
...
the **Compare tab** (side-by-side picks, champion split, lone-wolf flags, mavericks-vs-flock);
**local-time kickoffs** (with Kuwait time in brackets); the **share-preview card** (OG image);
**add-to-home-screen** (iPhone/Android PWA steps); plus a recap of the already-live features
(live title model, groups/knockout view, predictions leaderboard, live scores, MENA panel).
